...
setup(name='MSMcam',
      ...
      install_requires=["numpy>=1.13.0", "scipy==0.19.1", "pandas", "xlsxwriter", "scikit-image==0.13.0", "scikit_learn>=0.19", "termcolor", "reportlab==3.5.55", "imageio", "matplotlib>=1.5.3"],
      zip_safe=False)
